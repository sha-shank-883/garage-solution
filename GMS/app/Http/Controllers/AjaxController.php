...
//            exit;
    ...
    public function paymentForWorkshop(Request $request)
    {
       ...
       // $workshopDetail =DB::table('workshops')->join('customer','workshops.customer_id','=','customer.id')->get();
                                ...
                                $PaymentHistory->job_id    = $request->workshopIdForPayment;
                               
                                $PaymentHistory->payment_date    = $request->payment_dateForWorkhop;
                                $PaymentHistory->payment_amount    = $request->amountForWorkshop;

                                $kk=$request->amountForWorkshop;
