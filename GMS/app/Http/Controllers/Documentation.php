...
// $result = $result->toArray();
        ...
        return view('AutoCare.marketing.add',$viewData )->with($getMarketingDetails);
    }
   // this is for search
    public function view(Request $request)
    {
    	...
    	if($request->isMethod('post'))
    	{
		    ...
		    return view('AutoCare.marketing.search', $viewData)->with($getFormAutoFillup);;
		...
		//	$market= DB::table('purchases');
		    ...
		    return view('AutoCare.marketing.search', $viewData);
    	}
    ...
    public function trashedList()
    {
         ...
         return view('AutoCare.marketing.delete', compact('trashed', 'trashed'));
