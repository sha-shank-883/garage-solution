...
class MasterController extends Controller
{
      public function modal(Request $request)
    {
		...
		$viewData['model_list'] = Modal::with('brand')->get();
		$viewData['service_type_list'] = ServiceType::get();
		$viewData['service_name_list'] = ServiceName::get();
		$viewData['brand_list'] = Brand::get();
    	return view('AutoCare.master.modal',$viewData);
    }
    public function modalUpdate(Request $request,$id=null)
    {
        ...
        else
        {
            ...
            return view('AutoCare.master.modal',$viewData)->with($getFormAutoFillup);
    }
     public function service(Request $request)
    {
        ...
        $viewData['service_name_list'] = ServiceName::get();
        $viewData['brand_list'] = Brand::get();
    	return view('AutoCare.master.service',$viewData);
    }
    ...
    public function serviceUpdate(Request $request,$id=null)
    {
        ...
        else
        {
            ...
            return view('AutoCare.master.service',$viewData)->with($getFormAutoFillup);
    }
     public function brand(Request $request)
    {
    	...
    	if ($request->isMethod('post')){
			...
			$viewData['service_name_list'] = ServiceName::get();
			$viewData['brand_list'] = Brand::get();
    	return view('AutoCare.master.brand',$viewData);
    }
    public function brandUpdate(Request $request,$id=null)
    {
        ...
        else
        {
            ...
            $viewData['service_name_list'] = ServiceName::get();
            $viewData['brand_list'] = Brand::get();
            return view('AutoCare.master.brand',$viewData)->with($getFormAutoFillup);
    }
     public function serviceType(Request $request)
    {
    	...
    	return view('AutoCare.master.service_type',$viewData);
    }
     public function serviceTypeUpdate(Request $request,$id=null)
    {
        ...
        else
        {
            ...
            $viewData['service_name_list'] = ServiceName::get();
            $viewData['brand_list'] = Brand::get();
            return view('AutoCare.master.service_type',$viewData)->with($getFormAutoFillup);
    }
}
