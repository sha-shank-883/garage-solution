...
//     e.preventDefault();
//     const tyreId = $(this).data('product_id'); // Get the tyre ID from the button

//     $.ajax({
//         url: "{{ route('cart.add') }}", // Update with your route for adding items to the cart
//         type: "POST",
//         data: {
//             id: tyreId,
...
//                         window.location.href = "{{ route('checkout') }}"; // Redirect to checkout page
//                     }
//                 });
//             } else {
