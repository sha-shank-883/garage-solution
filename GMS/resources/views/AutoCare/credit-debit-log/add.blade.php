  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="form-group">
          <label class="form-col-form-label" for="supplier_name">Log Date</label>
              <input type="text" id="logDate"  name="created_at" class="form-control"  value="{{ isset($created_at)?$newDate = preg_replace("/(\d+)\D+(\d+)\D+(\d+)/","$1-$2-$3",$created_at) : '' }}">
          </div>
        </div>
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table id="addmoretable" class="table table-bordered">
                  ...
                  <tbody id="tBody">
                    <tr id="addRow">                 
                      <td class="item">{{Form::text('item[]', isset($item)?$item: '', ['class' => 'form-control ', 'id' => 'item','required'=>'required'])}}
                      </td>
                      ...
                      <td class="amount">{{Form::number('amount[]', isset($amount)?$amount: '', ['class' => 'form-control ', 'id' => 'amount','required'=>'required'])}}
                      </td>  
                        @php
                        if(!isset($id))
                        {
