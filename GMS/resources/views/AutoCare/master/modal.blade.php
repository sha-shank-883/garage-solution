...
<section class="content" style="margin-left: 20px;margin-right: 20px;">
    ...
    <div class="card-header">
      <h4 class="box-title text-primary ">Please Fill Up Model Details</h4>
    </div>
    <div class="card-body">
      <div class="row">
        <!-- left column -->
                ...
                <tbody>
                  ...
                  <tr>
                   ...
                   <a href="{{ url('/')}}/master/modal/update/{{ $value['id'] }}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a> 
                      <a style="display: none" href="{{ url('/')}}/master/modal/trash/{{ $value['id']}} " class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this user?');"><i class="fa fa-remove"></i></a>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
                  </tr>
