...
<section class="content" style="margin-left: 20px;margin-right: 20px;">
   {{ isset($id)?Form::open(['url' => 'AutoCare/product/update','files' => 'true' ,'enctype' => 'multipart/form-data', 'autocomplete' => 'OFF']) : Form::open(['url' => 'AutoCare/product/add','files' => 'true' ,'enctype' => 'multipart/form-data', 'autocomplete' => 'OFF']) }} 
   {{ csrf_field() }}
    ...
    <div class="card-body">
      ...
      <div class="row">
        ...
        <div class="col-md-3">
          ...
          {{Form::number('unit_price',isset($unit_price)?$unit_price: '', ['class' => 'form-control form-control ', 'placeholder' => 'Unit Price','step'=>'0.01'] )}}
          <div class="invalid-feedback">
         ...
         <div class="col-md-3">
          <div class="form-group">
          <label class="form-col-form-label" for="unit_price_exit">Unit Exit Price</label>
          {{Form::number('unit_price_exit',isset($unit_price_exit)?$unit_price_exit: '', ['class' => 'form-control form-control ', 'placeholder' => 'Unit Exit Price','step'=>'0.01'] )}}
          <div class="invalid-feedback">
          {{ $errors->has('unit_price_exit') ? $errors->first('unit_price_exit', ':message') : '' }}
          </div>
          </div>
        </div> 
        <div class="col-md-3">
          ...
          {{Form::number('gst',isset($gst)?$gst: 0, ['class' => 'form-control form-control ', 'placeholder' => 'GST','step'=>'0.01'] )}}
          <div class="invalid-feedback">
