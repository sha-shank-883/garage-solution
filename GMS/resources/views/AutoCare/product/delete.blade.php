              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style="white-space: nowrap">
                      <a href="{{ url('/')}}/AutoCare/product/delete/{{ $value['id']}} " class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this user?');"><i class="fa fa-trash"></i></a>
                  </td>
                </tr>  
                @endforeach
              </tbody>
