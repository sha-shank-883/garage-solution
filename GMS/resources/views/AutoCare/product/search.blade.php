...
<section class="content" style="margin-left: 20px;margin-right: 20px;">
  <div class="row">
      ...
      <div class="col-sm-12" class="text-center">
         {{ Form::open(['url' => 'AutoCare/product/search','files' => 'true' ,'enctype' => 'multipart/form-data', 'autocomplete' => 'OFF']) }} 
        ...
        <table class="table">
          <tr>
            ...
            <td><!-- <input type="text" class="form-control" name="id"> -->
                {{Form::text('id', isset($id)?$id: '', ['class' => 'form-control form-control ','id'=>'id', 'placeholder' => 'Spare Id']  )}}
            </td>
            <td>&emsp;&emsp;</td>
            <td>Spare Name</td>
            <td>:</td>
            <td>
              {{Form::text('product_name', isset($product_name)?$product_name: '', ['class' => 'form-control form-control ','id'=>'product_name', 'placeholder' => 'Spare Name']  )}}
            <td>&emsp;&emsp;</td>
            <td>From Date</td>
            <td>:</td>
    ...
    <div class="col-sm-12">
        <div class="card">
          <div class="card-header">
            <i class="fa fa-align-justify"></i>Product Details
          </div>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style="white-space: nowrap">
                   <a  href="{{ url('/')}}/AutoCare/product/add/{{ $value['id'] }}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a> 
                      <a style="display: none" href="{{ url('/')}}/AutoCare/product/trash/{{ $value['id']}} " class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this user?');"><i class="fa fa-remove"></i></a>
                  </td>
                </tr>  
                @endforeach
              </tbody>
