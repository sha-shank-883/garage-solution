...
<section class="content" style="margin-left: 20px;margin-right: 20px;">
  <div class="row">
      <div class="col-sm-12" class="text-center">
         {{ Form::open(['url' => '/SupplierCreditDebitLog/search','files' => 'true' ,'enctype' => 'multipart/form-data']) }} 
         <div class="table-responsive">
        <table class="table table-sm">
          <tr>
            <td>Supplier Debit Log  Id</td>
            <td>:</td>
            <td><!-- <input type="text" class="form-control-sm" name="id"> -->
                {{Form::text('id', isset($id)?$id: '', ['class' => 'form-control-sm form-control-sm ','id'=>'id', 'placeholder' => 'Supplier Debit Log  Id']  )}}
            </td>
            <td>&emsp;&emsp;</td>
            <td>Supplier Name</td>
            <td>:</td>
            <td>
              {{Form::text('user_name', isset($user_name)?$user_name: '', ['class' => 'form-control-sm form-control-sm ','id'=>'user_name', 'placeholder' => ' Supplier Name']  )}}
            <td>&emsp;&emsp;</td>
          </tr>
          <tr>
            <td>From Date</td>
            ...
            <table id="datable_1" class="table  table-hover  " style="font-size: 13px;display:table-cell;" >
              <thead class="thead-dark">
                <tr>
                  ...
                  <th style="white-space: nowrap">Spare Brand</th>
                  <th style="white-space: nowrap">Spare Model </th>
