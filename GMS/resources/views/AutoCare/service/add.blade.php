...
<section class="content" style="margin-left: 20px;margin-right: 20px;">
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <div class="row" id="modelDivHide" >
        ...
        <div class="col-sm-2 text-success" id="serviceTypeShow" align="center"><button class="btn btn-primary btn-sm"><i class="fa fa-plus-circle fa-1x " aria-hidden="true" ></i></button>Add Service Type</div>
        <div class="col-sm-3 text-primary" id="serviceShow" align="center"><button class="btn btn-primary btn-sm"><i class="fa fa-plus-circle fa-1x " aria-hidden="true" ></i></button>Add Service</div>
         <div class="col-sm-1 text-primary text-right" id="HideAll" align="center"><button class="btn btn-danger btn-sm"><i class="fa fa-minus-circle fa-1x " aria-hidden="true" ></i></button></div>
      </div>
      <div id="modelDiv" class="row"   > 
        <div class="col-md-6" style="box-shadow: 0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 18px 0 rgba(0,0,0,0.19);">
          <div class="card">
            {{ Form::open(['url' => 'AutoCare/model/add','files' => 'true' ,'enctype' => 'multipart/form-data', 'autocomplete' => 'ON']) }}
  ...
  text-shadow: 1px 1px 2px black, 0 0 25px blue, 0 0 5px darkblue;">Model List </div>
      ...
      <div class="row" id="brandDiv">
        <div class="col-md-6" style="box-shadow: 0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 18px 0 rgba(0,0,0,0.19);">
          <div class="card">
            {{ Form::open(['url' => 'AutoCare/brand/add','files' => 'true' ,'enctype' => 'multipart/form-data', 'autocomplete' => 'ON']) }}
       ...
       <div class="row" id="serviceDiv">
        <div class="col-md-6" style="box-shadow: 0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 18px 0 rgba(0,0,0,0.19);">
          <div class="card">
            {{ Form::open(['url' => 'AutoCare/service_name/add','files' => 'true' ,'enctype' => 'multipart/form-data', 'autocomplete' => 'ON']) }}
       ...
       <div class="row" id="serviceTypeDiv">
        <div class="col-md-6" style="box-shadow: 0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 18px 0 rgba(0,0,0,0.19);">
          <div class="card">
            {{ Form::open(['url' => 'AutoCare/serviceType/add','files' => 'true' ,'enctype' => 'multipart/form-data', 'autocomplete' => 'ON']) }}
 ...
 <div class="row"><div class="col-md-12">&nbsp;</div></div>
      ...
      {{ isset($id)?Form::open(['url' => 'AutoCare/service/update','files' => 'true' ,'enctype' => 'multipart/form-data', 'autocomplete' => 'OFF']) : Form::open(['url' => 'AutoCare/service/add','files' => 'true' ,'enctype' => 'multipart/form-data', 'autocomplete' => 'OFF']) }} 
   {{ csrf_field() }}
