...
<section class="content" style="margin-left: 20px;margin-right: 20px;">
  <div class="row">
      ...
      <div class="col-sm-12" class="text-center">
         {{ Form::open(['url' => 'AutoCare/service/search','files' => 'true' ,'enctype' => 'multipart/form-data', 'autocomplete' => 'ON']) }} 
    ...
    <div class="col-sm-12">
        <div class="card">
          <div class="card-header">
            <i class="fa fa-align-justify"></i> Service Details
          </div>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style="white-space: nowrap">
                   <a href="{{ url('/')}}/AutoCare/service/add/{{ $value['id'] }}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a> 
                     {{--  <a href="{{ url('/')}}/AutoCare/service/trash/{{ $value['id']}} " class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this user?');"><i class="fa fa-remove"></i></a> --}}
                  </td>
                </tr>  
                @endforeach
              </tbody>
