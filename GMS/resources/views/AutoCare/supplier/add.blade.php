...
{{ Form::open(['url' => 'tyres/import', 'files' => true, 'enctype' => 'multipart/form-data']) }}
{{ csrf_field() }}

<div class="form-group">
  <label for="csv_file">Upload Tyres CSV</label>
  {{ Form::file('csv_file', ['class' => 'form-control', 'accept' => '.csv', 'required']) }}
</div>

<div class="form-group text-center">
  <button type="submit" class="btn btn-primary">Import Tyres</button>
</div>
