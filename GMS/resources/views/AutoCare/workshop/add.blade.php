        ...
        <div class="box box-primary">
          ...
          <div class="box-body">
            ...
            <div class="alert alert-{{ session('message.level') }} alert-dismissible" onload="javascript: Notify('You`ve got mail.', 'top-right', '5000', 'info', 'fa-envelope', true); return false;">
              ...
              @if(isset($id))
              <div class="text-center text-primary"><a id="openWorkshopDetail"  target="blank" href="{{url('/')}}/AutoCare/workshop/view/{{ isset($id) ? $id : '' }}">Show Detail</a></div>
              ...
              @else
               <div class="text-center text-primary"><a  id="openWorkshopDetail"  target="blank" href="{{url('/')}}/AutoCare/workshop/view/{{ isset($workshopId) ? $workshopId : '' }}">Show Detail</a></div>
                <script type="text/javascript">
                 $(document).ready(function(){
                  setTimeout(function(){
                   $('#openWorkshopDetail').trigger('click');
...
<div class="card-body">
    <div class="row">
      <div class="col-md-3">
        <div class="form-group">
          ...
          {{Form::text('vehicle_reg_number',isset($vehicle_reg_number)?$vehicle_reg_number: '', ['class' => 'form-control ', 'placeholder' => 'Vehicle Reg Number','autocapitalize'=>'word','onkeyup'=>'this.value = this.value.toUpperCase()','style'=>'text-transform: uppercase;','required'=>'required'] )}}
          <div class="invalid-feedback">
              ...
              <table class="table">
               <thead>
                {{-- <th style="white-space: nowrap">Brand Name&emsp;&emsp;&emsp;&emsp;&emsp;</th> --}}
                 ...
                 <th style="white-space: nowrap;display: none">Quantity&emsp;&emsp;</th>
              ...
              <tr id="AddRowForService{{ $incrimentedIdForService }}">
                  ...
                  <td  class="service_type">{{Form::select('service_type_id[]',$ServiceType, isset($value['service_type_id'])?$value['service_type_id']: '', ['class' => 'form-control','required'=>'true','placeholder'=>'Select' ,'id' => 'service_type',isset($id)?'disabled="true"':''])}}
                    ...
                    <td  class="service_id">{{Form::select('service_id[]',$service, isset($value['service_id'])?$value['service_id']: '', ['class' => 'form-control ','required'=>'true','placeholder'=>'Select' ,'id' => 'service_id',isset($id)?'disabled="true"':''])}}
                     ...
                     <td style="display:none" >
                      {{Form::number('service_quantity[]',isset($value['service_quantity'])?1:1,['class'=>'form-control selectTo','required',isset($id)?'disabled="true"':''])}}
                ...
                @endphp
                 ...
                 {{--  <td>
                  ...
                  <td  class="service_type">{{Form::select('service_type_id[]',$ServiceType, isset($service_type_id)?$service_type_id: '', ['class' => 'form-control serviceTypeSelect2','required'=>'true','placeholder'=>'Select' ,'id' => 'service_type'])}}
                    </td>
                    <td  class="service_id">{{Form::select('service_id[]',$service, isset($service_id)?$service_id: '', ['class' => 'form-control selectToJ2','required'=>'true','placeholder'=>'Select' ,'id' => 'service_id'])}}
                     ...
                     <td style="display:none"  >
                      {{Form::text('service_quantity[]',isset($service_quantity)?1:1,['class'=>'form-control','required'])}}
                    </td>
                 ...
                 @else
                  <tr class="estimatedCost" >
                    ...
                    <td>
                      ...
                      <td  class="service_name">{{Form::select('product_id[]',$product, isset($product_id)?$product_id: '', ['class' =>  'form-control selectToJ1','placeholder'=>'Select' ])}}
                      </td>
                      <td>
                         {{Form::number('product_quantity[]',isset($product_quantity)?$product_quantity:'',['class'=>'form-control'])}}
                      </td>
                       <td  ><input type="number" id="product_price" name="product_price[]" class="form-control" ></div>
                      </td>
                      <td>
 ...
 @if(!isset($id))
        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">Possible Required Spare</div>
            <div class="card-body table-responsive">
              <table class="table">
               <thead>
                 <th style="white-space: nowrap" >Brand Name&emsp;&emsp;&emsp;&emsp;&emsp;</th>
               ...
               <tbody id="tBodyForProductTable_es">
                @if(isset($workshopProductData))
                @php
                  $incrimentedId_es=0
                @endphp
                  @foreach($workshopProductData as $key=> $value)
                  <tr id="AddRowForProduct_es{{ $incrimentedId_es }}">
                     <td>
                     {{Form::select('workshop_product_brand_es[]',$brand_select,isset($value['workshop_product_brand_es'])?$value['workshop_product_brand_es']: '', ['class' => 'form-control ',isset($id)?'disabled="true"':'', 'placeholder' => 'Brand'] )}}                        
                           {{ Form::hidden('workshop_product_brand_es[]', isset($id) ? $value['workshop_product_brand_es'] :'', []) }} 
                  </td>
                  <td>
                     {{Form::select('workshop_product_model_es[]]',$model_select,isset($value['workshop_product_model_es'])?$value['workshop_product_model_es']: '', ['class' => 'form-control ',isset($id)?'disabled="true"':'', 'placeholder' => 'Model Name'] )}}
                     {{ Form::hidden('workshop_product_model_es[]', isset($id) ? $value['workshop_product_model_es'] :'', []) }} 
                  </td>
                    <td  class="service_name">{{Form::select('product_id_es[]',$product, isset($value['product_id_es'])?$value['product_id_es']: '', ['class' =>  'form-control selectTo','required'=>'true','placeholder'=>'Select' ,isset($id)?'disabled="true"':'','id' => 'product_id'])}}
                       {{ Form::hidden('product_id[]', isset($id) ? $value['product_id_es'] :'', []) }} 
                    </td>
                    <td>
                       {{Form::number('product_quantity_es[]',isset($value['product_quantity_es'])?$value['product_quantity_es']:'',['class'=>'form-control','required',isset($id)?'disabled="true"':''])}}
                        {{ Form::hidden('product_quantity_es[]', isset($id) ? $value['product_quantity_es'] :'', []) }} 
                    </td>
                     <td >
                      {{Form::number('product_price_es[]',isset($value['product_price_es'])?$value['product_price_es']:'',['class'=>'form-control','required',isset($id)?'disabled="true"':''])}}
                       {{ Form::hidden('product_price_es[]', isset($id) ? $value['product_price_es'] :'', []) }} 
                      {{-- <div><input type="number" id="product_price" name="product_price[]" class="form-control" required="true"></div> --}}
                    </td>
                    <td><a href="javascript:void(0)" id="{{ $incrimentedId }}"   class="removeRowForProduct btn btn-danger btn-sm"><i class="fa fa-minus "></i></a></td>
                ...
                @endphp
                  @endforeach
                 @else
                  <tr class="estimatedCost_es" >
                    <td>
                       {{Form::select('workshop_product_brand_es[]',$brand_select,isset($workshop_product_brand_es)?$workshop_product_brand_es: '', ['class' => 'form-control selectToW1_es', 'placeholder' => 'Brand'] )}}
                    </td>
                    <td>
                       {{Form::select('workshop_product_model_es[]]',$model_select,isset($workshop_product_model_es)?$workshop_product_model_es: '', ['class' => 'form-control selectToW2_es', 'placeholder' => 'Model Name'] )}}
                    </td>
                      <td  class="service_name">{{Form::select('product_id_es[]',$product, isset($product_id_es)?$product_id_es: '', ['class' =>  'form-control selectToJ1_es','placeholder'=>'Select' ])}}
                      </td>
                      <td>
                         {{Form::number('product_quantity_es[]',isset($product_quantity_es)?$product_quantity_es:'',['class'=>'form-control'])}}
                      </td>
                       <td  ><input type="number" id="product_price" name="product_price_es[]" class="form-control" ></div>
                      </td>
                      <td>
                      <a href="javascript:void(0)"  class="addMoreForProduct_es btn btn-primary btn-sm"><i class="fa fa-plus "></i></a>
                      </td>        
                  </tr> 
                @endif
               </tbody>
                        ...
                        <div class="col-md-4" >
                          <div class="form-group" >
                            <label class="control-label"  for="paid_price"> Advance Received :&emsp;</label>
                             {{Form::number('paid_price',isset($paid_price)?$paid_price: 0, ['class' => 'form-control ','step'=>'any','required'=>'true'])}}
                            <div class="invalid-feedback">
...
<script type="text/javascript">
 ...
 //   $('#docForProduct').show();
  ...
  //  $('#docForProduct').toggle();
    ...
    @else
     var k={{ $incrimentedId_es }};
    @endif



    $('.addMoreForProduct_es').on("click",function(){
        i=parseFloat(i)+1;
          $("#tBodyForProductTable_es").append('<tr id="AddRowForProduct_es'+k+'">\
          <td >{{Form::select("workshop_product_brand_es[]",$brand_select, isset($workshop_product_brand)?$workshop_product_brand: "", ["class"=>"form-control selectToW1_es","required"=>"true","placeholder"=>"Select" ])}}\
          </td>\
           <td >{{Form::select("workshop_product_model_es[]",$model_select, isset($workshop_product_model)?$workshop_product_model: "", ["class"=>"form-control selectToW2_es","required"=>"true","placeholder"=>"Select" ])}}\
          </td>\
          <td >{{Form::select("product_id_es[]",$product, isset($product_id)?$product_id: "", ["class"=>"form-control product_id selectToJ1_es","required"=>"true","placeholder"=>"Select" ])}}\
          </td>\
          <td>{{Form::number("product_quantity_es[]",isset($product_quantity)?$product_quantity:"",["class"=>"form-control ","required"])}}</td>\
          <td><input type="number" id="product_price" name="product_price_es[]" class="form-control" required="required"></div>\
          </td>\
          <td>\
          <a href="javascript:void(0)"  id="'+k+'"  class="removeRowForProduct_es btn btn-danger btn-sm"><i class="fa fa-minus "></i></a>\
          </td>   \
          </tr>');
     ...
     // $('.selectTo').select2();
      ...
      $('.addMoreForProduct').on("click",function(){
        i=parseFloat(i)+1;
          ...
          <td><input type="number" id="product_price" name="product_price[]" class="form-control" required="required"></div>\
          </td>\
          <td>\
     ...
     // $('.selectTo').select2();
      ...
      $('.addMoreForService').on("click",function(){
        j=parseFloat(j)+1;       
          ...
          <td class="service_type"><select name="service_type_id[]" class="form-control serviceTypeSelect2 SericeType_'+j+'"></select></td>\
          <td class="service_name">{{Form::select("service_id[]",$service, isset($service_id)?$service_id: "", ["class"=> "form-control selectToJ2","required"=>"true","placeholder"=>"Select" ])}}\
           ...
           <td style="display:none">{{Form::text("service_quantity[]",isset($service_quantity)?1:1,["class"=>"form-control","required"])}}</td>\
        ...
        var brand = $('[name^=brand]').val();
         $('.SericeType_'+j).attr('disabled','true')
         $.ajax({
        type:"POST",
        ...
        success: function(data){
            $('.SericeType_'+j).removeAttr('disabled','true')
      ...
      $(document).on('click', '.removeRowForProduct_es', function(){  
          var button_id = $(this).attr("id");  
          $('#AddRowForProduct_es'+button_id+'').remove();  
      }); 
         ...
         if (typeof(Storage) != "undefined") {
            ...
            $('[name^=model_number]')
                ...
                for (index = 0; index < modalData.length; ++index) {
                  if(parseInt(ifModelAlreadyFromLocalSorage)==parseInt(modalData[index]['id']))
                  {
                    $('[name^=model_number]').append(
                    '<option value="'+modalData[index]['id']+'" selected >'+modalData[index]['model_name']+'</option>'
                    ); 
                     localStorage.removeItem("model_number_localStorage");
                      // console.log(ifModelAlreadyFromLocalSorage.toString());
                  }
                  else
                  {
                    $('[name^=model_number]').append(
          ...
          setTimeout(function(){
              if(ifModelAlreadyFromLocalSorage)
              {
                ...
                $("[name=model_number]").val(ifModelAlreadyFromLocalSorage).change();
                 // $("[name=model_number]").change();
                localStorage.removeItem("model_number_localStorage");
              }
            }, 5000);
         ...
         var thisSelf=$(this);
             ...
             success: function(data){
              ...
              if(productDetail)
              {
                ...
                if (typeof(productDetail[0].unit_price_exit) == "undefined" && !productDetail[0].unit_price_exit)
                {
...
$(document).on("change","[name^=service_type_id]",function(){
      ...
      // var brand = thisSelf.parent().parent().find('[name^=workshop_service_brand]').val();
      // var model = thisSelf.parent().parent().find('[name^=workshop_service_model]').val();
      var model = $('[name^=model_number]').val();
      var brand = $('[name^=brand]').val();
      $.ajax({
        type:"POST",
        url: "{{url('/')}}/ajax/getServiceTypeForWorkshop",
...
$(document).on('change', '[name^=service_id]', function(){  
         ...
         var thisSelf=$(this);
             ...
             success: function(data){
              ...
              {
                alert("Please Set Service Price ");
              }             
