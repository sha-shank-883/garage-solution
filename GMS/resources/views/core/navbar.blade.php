...
<header class="app-header navbar">
  ...
  <a  href="#"><div style="width:100%;" class="logo"><b><i>Worldgyan</i></b></div></a>
  ...
  <ul class="nav navbar-nav d-md-down-none"> 
    <li class="nav-item px-3">
      <a class="nav-link" href="/">WorldGyan GMS</i></a>
    </li>
{{-- 
    <li class="nav-item px-3">
  ...
  <ul class="nav navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu dropdown-menu-right">
        ...
        <a class="dropdown-item" href="{{url('/')}}/employee-edit/{{ auth()->user()->id }}"><i class="fa fa-bell-o"></i> Update<span class="badge badge-info">42</span></a>
       {{--  <a class="dropdown-item" href="#"><i class="fa fa-envelope-o"></i> Messages<span class="badge badge-success">42</span></a>
        ...
        <a class="dropdown-item"  href="{{url('/')}}/employee/{{ auth()->user()->id }}/view"><i class="fa fa-user"></i> Profile</a>
