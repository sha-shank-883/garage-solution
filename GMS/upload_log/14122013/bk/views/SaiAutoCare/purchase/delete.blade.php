        ...
        <div class="card">
          ...
          <div class="card-body table-responsive" style="font-size: 13px;padding-left:10px;vertical-align:middle;">
            <table id="datable_1" class="table  table-hover  " style="font-size: 13px;display:table-cell;" >
              ...
              <tbody>
                @foreach($TrashedPurchase as $key => $value)
                <tr>
                  <td>{{ $value['id'] }}</td>
                  ...
                  <td style="white-space: nowrap">
                      <a href="{{ url('/')}}/AutoCare/purchase/delete/{{ $value['id']}} " class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this user?');"><i class="fa fa-trash"></i></a>
                  </td>
                </tr>  
                @endforeach
              </tbody>
