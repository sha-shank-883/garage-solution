                ...
                <table id="addmoretable" class="table table-bordered">
                  ...
                  <tbody id="tBody">
                    <tr id="addRow">
                      ...
                      <td class="model_number">{{Form::text('model_number[]', isset($model_number)?$model_number: '', ['class' => 'form-control ', 'id' => 'model_number', 'style' => 'width:60px'])}}
                      </td>
                      <td class="hsn">{{Form::text('hsn[]', isset($hsn)?$hsn: '', ['class' => 'form-control ', 'id' => 'hsn', 'style' => 'width:60px'])}}
                      </td>
                      <td class="unit_price">{{Form::text('unit_price[]', isset($unit_price)?$unit_price: '', ['class' => 'form-control ', 'id' => 'unit_price', 'style' => 'width:60px'])}}
                      </td>
                      <td class="quantity">{{Form::text('quantity[]', isset($quantity)?$quantity: '', ['class' => 'form-control ', 'id' => 'quantity', 'style' => 'width:60px'])}}
                      </td>
                      <td class="gst">{{Form::text('gst[]', isset($gst)?$gst: '', ['class' => 'form-control ', 'id' => 'gst', 'style' => 'width:60px'])}}
                      </td>
                      <td class="discount">{{Form::text('discount[]', isset($product_id)?$product_id: '', ['class' => 'form-control ', 'id' => 'discount', 'style' => 'width:60px'])}}
                      </td>
                      <td class="total_amount">{{Form::text('total_amount[]', isset($total_amount)?$total_amount: '', ['class' => 'form-control ', 'id' => 'total_amount', 'style' => 'width:60px'])}}
                      </td>
      ...
      $('.addMore').on("click",function(){
        i=parseInt(i)+1;
         $("#tBody").append('<tr id="AddRow'+i+'">\
                    ...
                    <td class="model_number">{{Form::text("model_number[]", "", ["class" => "form-control ", "id" => "model_number", "style" => "width:60px"])}}\
                    </td>\
                    <td class="hsn">{{Form::text("hsn[]", "", ["class" => "form-control ", "id" => "hsn", "style" => "width:60px"])}}\
                    </td>\
                    <td class="unit_price">{{Form::text("unit_price[]", "", ["class" => "form-control ", "id" => "unit_price", "style" => "width:60px"])}}\
                    </td>\
                    <td class="quantity">{{Form::text("quantity[]", "", ["class" => "form-control ", "id" => "quantity", "style" => "width:60px"])}}\
                    </td>\
                    <td class="gst">{{Form::text("gst[]", "", ["class" => "form-control ", "id" => "gst", "style" => "width:60px"])}}\
                    </td>\
                    <td class="discount">{{Form::text("discount[]", "", ["class" => "form-control ", "id" => "discount", "style" => "width:60px"])}}\
                    </td>\
                    <td class="total_amount">{{Form::text("total_amount[]", "", ["class" => "form-control ", "id" => "total_amount", "style" => "width:60px"])}}\
                    </td>\
                    <td>\
