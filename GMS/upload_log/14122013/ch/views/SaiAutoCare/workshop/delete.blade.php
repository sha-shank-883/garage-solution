                 ...
                 <!--  <td>{{ $value['vin'] }}</td>
                  ...
                  <td style="white-space: nowrap">
                   <!-- <a href="{{ url('/')}}/gst/manage-party/add/{{ $value['id'] }}" class="btn btn-success btn-xs"><i class="fa fa-edit"></i></a>  -->
                      <a href="{{ url('/')}}/AutoCare/workshop/delete/{{ $value['id']}} " class="btn btn-danger btn-xs" onclick="return confirm('Are you sure you want to delete this user?');"><i class="fa fa-trash"></i></a>
                  </td>
                </tr>  
                @endforeach
              </tbody>
