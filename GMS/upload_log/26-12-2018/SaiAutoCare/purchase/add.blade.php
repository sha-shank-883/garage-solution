...
<section class="content" style="margin-left: 20px;margin-right: 20px;">
  ...
  <div class="card">
    <div class="card-header">
      <h4 class="box-title text-primary ">Please Fill Up Product Details</h4><a href=""></a>
    </div>
    <div class="card-body">
      <div class="row">
        <!-- left column -->
                  ...
                  <tbody id="tBody">
                    <tr id="addRow">
                      ...
                      <td class="part_number">{{Form::text('part_number[]', isset($part_number)?$part_number: '', ['class' => 'form-control ', 'id' => 'part_number'])}}
                       ...
                       <td class="discription">{{Form::text('discription[]', isset($discription)?$discription: '', ['class' => 'form-control ', 'id' => 'discription'])}}
                      </td>                      
                      ...
                      <td class="quantity">{{Form::text('quantity[]', isset($quantity)?$quantity: '', ['class' => 'form-control qtn', 'id' => 'quantity'])}}
                      </td>
      ...
      $('.addMore').on("click",function(){
        i=parseInt(i)+1;
         $("#tBody").append('<tr id="AddRow'+i+'">\
                    ...
                    <td class="discription">{{Form::text("discription[]", "", ["class" => "form-control ", "id" => "discription",])}}\
                    </td>\
